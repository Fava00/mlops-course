...
### Exercise 4: 
The erros is being raised by the config.py validation module, because PIPELINE_TEST_SIZE=1.5 is outside of the valid range for a test split (should be between 0 and 1)
